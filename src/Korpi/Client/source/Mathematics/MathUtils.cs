...
public static class MathUtils
{
    ...
    public static IEnumerable<(int x, int y, int z)> BresenhamLine3D(int x1, int y1, int z1, int x2, int y2, int z2)
    {
        ...
        int shortest = System.Math.Min(System.Math.Abs(dy), System.Math.Abs(dz));

        if (longest <= shortest)
        {
            longest = System.Math.Max(System.Math.Abs(dy), System.Math.Abs(dz));
            shortest = System.Math.Min(System.Math.Abs(dy), System.Math.Abs(dz));
