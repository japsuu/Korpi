...
{
    private static readonly IKorpiLogger Logger = LogFactory.GetLogger(typeof(BlockTextureRegistry));
    
    public static Texture2DArray BlockArrayTexture { get; private set; } = null!;
    
    private static BlockArrayTextureBuilder? arrayTextureBuilder;
    
    
    public static void StartTextureRegistration()
    {
        arrayTextureBuilder = new BlockArrayTextureBuilder();
